...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Update a post.</h1>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="clearfix">
                            <form method="POST" action="{{ url('master/posts/'.$post->id) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="quill-editor">{!! $post->description !!}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="image" class="cursor-pointer">
                                        <img src="{{ asset($post->image) }}" alt="{{ $post->name }}" width="100"
                                            height="100" id="post-image">
                                    </label>
                                    <p class="form-text text-muted">Click the image to upload new file.</p>
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_description"
                                        ...
                                        placeholder="Meta Description" rows="3">{{ $post->meta_description }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_keyword"
                                        ...
                                        placeholder="Meta Keyword" rows="3">{{ $post->meta_keyword }}</textarea>
                                    @error('meta_keyword')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
