            ...
            <div class="col-md-4 col-xl-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <img src="{{ asset('images/avatars/avatar-4.jpg') }}" alt="Christina Mason"
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1"><span class="fas fa-globe fa-fw me-1"></span> <a href="#">staciehall.co</a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body h-100">
                        ...
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('images/avatars/avatar-5.jpg') }}" width="36" height="36"
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('images/avatars/avatar.jpg') }}" width="36" height="36"
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('images/avatars/avatar-4.jpg') }}" width="36" height="36"
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('images/avatars/avatar-2.jpg') }}" width="36" height="36"
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="row g-0 mt-1">
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img src="{{ asset('images/photos/unsplash-1.jpg') }}" class="img-fluid pe-2"
                                            alt="Unsplash">
                                    </div>
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img src="{{ asset('images/photos/unsplash-2.jpg') }}" class="img-fluid pe-2"
                                            alt="Unsplash">
                                    </div>
                                </div>
