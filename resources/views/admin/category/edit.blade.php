                        ...
                        <div class="clearfix">
                            <form method="POST" action="{{ url('admin/categories') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="quill-editor">{!! $category->description !!}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_keyword"
                                        ...
                                        placeholder="Meta Keyword" rows="3">{{ $category->meta_keyword }}</textarea>
                                    @error('meta_keyword')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input name="display_on_navbar" class="form-check-input" type="checkbox"
                                            id="displayOnNav" {{ $category->display_on_navbar=='1'?'checked':'' }}>
