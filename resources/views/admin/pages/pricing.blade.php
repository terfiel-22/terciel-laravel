...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Plans &amp; Pricing</h1><a class="badge bg-primary ms-2"
        ...
        <div class="row">
            <div class="col-md-10 col-xl-8 mx-auto">
                ...
                <p class="lead text-center mb-4">Whether you're a business or an individual, 14-day trial no credit card
                    required.</p>

                <div class="row justify-content-center mt-3 mb-2">
                    <div class="col-auto">
                        <nav class="nav btn-group">
                            <a href="#monthly" class="btn btn-outline-primary active" data-bs-toggle="tab">Monthly
                                billing</a>
                    ...
                    <div class="col-md-5 col-sm-6 ms-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem
