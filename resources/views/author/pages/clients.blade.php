                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{ asset('images/avatars/avatar.jpg') }}" width="32" height="32"
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/avatars/avatar-2.jpg') }}" width="32" height="32"
                                            class="rounded-circle my-n1" alt="Avatar"></td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/avatars/avatar-3.jpg') }}" width="32" height="32"
                                            class="rounded-circle my-n1" alt="Avatar"></td>
                                    <td>Michael Silva</td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/avatars/avatar-4.jpg') }}" width="32" height="32"
                                            class="rounded-circle my-n1" alt="Avatar"></td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/avatars/avatar-5.jpg') }}" width="32" height="32"
                                            class="rounded-circle my-n1" alt="Avatar"></td>
                    ...
                    <div class="card-body">
                        <div class="row g-0">
                            <div class="col-sm-3 col-xl-12 col-xxl-3 text-center">
                                <img src="{{ asset('images/avatars/avatar-3.jpg') }}" width="64" height="64"
